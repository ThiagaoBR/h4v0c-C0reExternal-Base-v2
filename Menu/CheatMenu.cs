...
namespace C0reExternalBase_v2.Menu
{
    class CheatMenu
    {
        public static Item[] Items = new Item[] {
            new Item { m_sName = "ESP", m_sControlType = "Switch", m_bIsActive = true, m_bIsHovered = true},
            ...
            new Item { m_sName = "BunnyHop", m_sControlType = "Switch", m_bIsActive = true, m_bIsHovered = false},
        ...
        private static void RenderMenu(Renderer Render)
        {
            ...
            Render.DrawText("IRINEUCHEAT | BY H4V0C v1.0", true, m_Position.x + m_Size.x / 2, m_Position.y - 25, Color.GreenYellow, 3);
